            ...
            <SchedulePricingDiv>
                ...
                <div className='info'>
                    <div className='threeyo'>
                        <h2>Three Year Old Classes <span>$80/month</span></h2>
                        ...
                        <p>$80 per month with a $45 non-refundable materials fee</p>
                    </div>
                    <div className='fouryo'>
                        <h2>Four Year Old Classes <span>$100/month</span></h2>
                        <h4>Age 4 by September</h4>
                        <p>Classes are Monday, Wednesday, and Friday</p>
                        <p>Morning classes are 9am - 11:30am</p>
                        <p>Afternoon classes are 12pm - 2:30pm</p>
                        <p>$100 per month with a $60 non-refundable materials fee</p>
                    </div>
                </div>
